...
SECRET_KEY = '^u-u3ck^e00toegp$p_(210ksk8jxi39*&w$_r1pt*db=n-u%r'
...
INSTALLED_APPS = [
    ...
    'permit_app.apps.PermitAppConfig',
]
...
REST_AUTH_SERIALIZERS = {
    'TOKEN_SERIALIZER' : 'Transport.CustomLoginSerializer.TokenSerializer',
}
